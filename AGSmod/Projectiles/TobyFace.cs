...
namespace AGSmod.Projectiles
{
	public class TobyFace : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			else
			{
				...
				Main.PlaySound(mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/woof"), projectile.position);
			}
			return false;
		}
