...
namespace AGSmod.NPCs
{
	[AutoloadHead]
	public class GuyDefnot : ModNPC
	{
		public override string Texture
		{
			get
			{
				return "AGSmod/NPCs/GuyDefnot/GuyDefnot";
			}
		}
		...
		public override string[] AltTextures
		{
			get
			{
				return new string[] { "AGSmod/NPCs/GuyDefnot/GuyDefnot_Alt_1" };
			}
		}

		public override bool Autoload(ref string name)
		{
			name = "Waterbottle Guy";
			return mod.Properties.Autoload;
		}

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Waterbottle Guy");
		...
		public override string GetChat()
		{
			...
			switch (Main.rand.Next(8))
			{
				...
				case 3:
					return Main.LocalPlayer.name + " have you checked your pulse lately";
				case 4:
		...
		*/
		...
		public override void SetupShop(Chest shop, ref int nextSlot)
		{
			...
			nextSlot++;
			if (NPC.downedQueenBee || Main.hardMode) {
